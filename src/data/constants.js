...
export const OFFENSIVE_VGC_ABILITIES = [
  ...
  { apiName: 'analytic', name: 'Analytic (1.3x when moving last)' },
  { apiName: 'reckless', name: 'Reckless (1.2x Recoil/Crash moves)' },
  { apiName: 'solar-power', name: 'Solar Power (1.5x Special in sun)' },
  { apiName: 'flare-boost', name: 'Flare Boost (1.5x Special when burned)' },
  { apiName: 'sheer-force', name: 'Sheer Force (1.3x moves w/ secondary)' },
  { apiName: 'protosynthesis', name: 'Protosynthesis (1.3x highest stat)' },
  { apiName: 'quark-drive', name: 'Quark Drive (1.3x highest stat)' },
  { apiName: 'overgrow', name: 'Overgrow (1.5x Grass in pinch)' },
  { apiName: 'blaze', name: 'Blaze (1.5x Fire in pinch)' },
  { apiName: 'torrent', name: 'Torrent (1.5x Water in pinch)' },
  { apiName: 'swarm', name: 'Swarm (1.5x Bug in pinch)' },
...
export const DEFENSIVE_VGC_ABILITIES = [
  ...
  { apiName: 'soundproof', name: 'Soundproof (immune Sound moves)' },
  { apiName: 'protosynthesis', name: 'Protosynthesis (1.3x highest stat)' },
  { apiName: 'quark-drive', name: 'Quark Drive (1.3x highest stat)' },
