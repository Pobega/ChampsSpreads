...
// normalized to PokeAPI move names. Z-moves and LGPE partner-exclusive signature
// moves are omitted since they can't be selected in normal play.
export const CONTACT_MOVES = new Set([
  ...
  'bullet-punch', 'ceaseless-edge', 'chip-away', 'circle-throw', 'clamp', 'close-combat',
  'collision-course', 'comet-punch', 'comeuppance', 'constrict', 'counter', 'covet',
  'crabhammer', 'cross-chop', 'cross-poison', 'crunch', 'crush-claw', 'crush-grip',
  'cut', 'darkest-lariat', 'dig', 'dire-claw', 'dive', 'dizzy-punch',
  ...
  'flip-turn', 'fly', 'flying-press', 'focus-punch', 'force-palm', 'foul-play',
  ...
  'lash-out', 'last-resort', 'leaf-blade', 'leech-life', 'lick', 'liquidation',
  'low-kick', 'low-sweep', 'lunge', 'mach-punch', 'mega-kick', 'mega-punch',
  'megahorn', 'metal-claw', 'meteor-mash', 'mighty-cleave', 'mortal-spin', 'multi-attack',
  'needle-arm', 'night-slash', 'nuzzle', 'outrage', 'payback', 'peck',
  'petal-dance', 'phantom-force', 'plasma-fists', 'play-rough', 'pluck', 'poison-fang',
  'poison-jab', 'poison-tail', 'population-bomb', 'pounce', 'pound', 'power-trip',
  'power-up-punch', 'power-whip', 'psyblade', 'psychic-fangs', 'psyshield-bash', 'punishment',
  'pursuit', 'quick-attack', 'rage', 'rage-fist', 'raging-bull', 'rapid-spin',
  'razor-shell', 'retaliate', 'return', 'revenge', 'reversal', 'rock-climb',
  'rock-smash', 'rolling-kick', 'rollout', 'sacred-sword', 'scratch', 'seismic-toss',
  'shadow-claw', 'shadow-force', 'shadow-punch', 'shadow-sneak', 'skitter-smack', 'skull-bash',
  'sky-drop', 'sky-uppercut', 'slam', 'slash', 'smart-strike', 'smelling-salts',
  'snap-trap', 'solar-blade', 'spark', 'spectral-thief', 'spin-out', 'spirit-break',
  'steamroller', 'steel-roller', 'steel-wing', 'stomp', 'stomping-tantrum', 'stone-axe',
  'storm-throw', 'strength', 'struggle', 'submission', 'sucker-punch', 'sunsteel-strike',
  'super-fang', 'supercell-slam', 'superpower', 'surging-strikes', 'tackle', 'tail-slap',
  'take-down', 'temper-flare', 'thief', 'thrash', 'throat-chop', 'thunder-fang',
  'thunder-punch', 'thunderous-kick', 'trailblaze', 'triple-axel', 'triple-dive', 'triple-kick',
  'trop-kick', 'trump-card', 'u-turn', 'upper-hand', 'v-create', 'vice-grip',
  'vine-whip', 'vital-throw', 'volt-tackle', 'wake-up-slap', 'waterfall', 'wave-crash',
  'wicked-blow', 'wild-charge', 'wing-attack', 'wood-hammer', 'wrap', 'wring-out',
